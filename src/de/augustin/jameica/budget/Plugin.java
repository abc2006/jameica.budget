...
{
	//hier können verschiedene Funktionen wie init, Install und Clean aufgerufen werden
	  ...
	  public void install() throws ApplicationException
	  {
	    ...
	    try {
				...
				EmbeddedDatabase db = new EmbeddedDatabase(res.getWorkPath() + "/db","budgetuser","budgetpassword");
